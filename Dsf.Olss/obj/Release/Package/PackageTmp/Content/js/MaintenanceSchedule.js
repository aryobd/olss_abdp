    ...
    if (historyUnitMaintenanceList == '') {
        ...
        var formatRowMTNItem = "<tr class='rowItem' id='row_{0}'>" +
                                        ...
                                        '<td>' +
                                            '<div class="input-group">' +
                                                ...
                                                '<input class="form-control text-right numeric currency thousandSeparator" id="MaintenanceItems_{0}__ItemCost" name="MaintenanceItems[{0}].ItemCost" onChange = "{14}" onkeypress="return event.charCode >= 48 && event.charCode <= 57" type="text" value="{4}">' +
                                                '</div>' +
                                        '</td>' +
                                        '<td>' +
                                            '<div class="input-group">' +
                                        ...
                                        '<td>' +
                                            '<div class="input-group">' +
                                                '<input class="form-control text-right numeric currency thousandSeparator" id="MaintenanceItems_{0}__Ppn" name="MaintenanceItems[{0}].Ppn" onkeypress="return event.charCode >= 48 && event.charCode <= 57" type="text" value="{7}">' +
                                                '</div>' +
                                        '</td>' +
                                        '<td>' +
                                            '<div class="input-group">' +
                                                '<input class="form-control text-right numeric currency thousandSeparator" id="MaintenanceItems_{0}__Pph" name="MaintenanceItems[{0}].Pph" onkeypress="return event.charCode >= 48 && event.charCode <= 57" type="text" value="{8}">' +
                                                '</div>' +
                                        '</td>' +
                                        '<td>' +
                                            '<div class="input-group">' +
                                                '<input id="MaintenanceItems_{0}__IsService" name="MaintenanceItems[{0}].IsService" type="checkbox" onChange = "{15}" value ="{9}" {10} >' +
                                                '</div>' +
                                        '</td>' +
        ...
        $.each(historyUnitMaintenanceList, function (i, data) {
            ...
            tableContent += formatRowMTNItem.format(i, (i + 1), data.MaintenanceItemCode, data.MaintenanceItemName, data.ItemCost, data.ActualAmount, data.Quantity, data.Ppn, data.Pph, data.IsService, checked, data.IdTb_MTN_HistoryMT, data.IdMaintenanceItem, data.IdTb_MTN_HistoryMTDtl,
                "calculatePPNPPH(" + i + ")", "calculatePPNPPHIsService(" + i + ",this)");
        });
...
function UpdateMaintenanceConfirmation() {
    ...
    function calculatePPNPPH(i) {
        ...
        if (actualResidualValue >= 0) {
            $('#MaintenanceItems_' + i + '__Ppn').val(0.1 * (parseFloat(actualResidualValue))).formatCurrency();

            if (actualResidualValue2 == true) {
                $('#MaintenanceItems_' + i + '__Pph').val(0.02 * parseFloat(actualResidualValue)).formatCurrency();
            }
            else {
        ...
        var newTr = $('' +
            '<tr class="rowItem" id="row_' + countRowItem + '">' +
                ...
                '<td>' +
                                        ...
                                        '<td>' +
                                            '<div class="input-group">' +
                                                '<input class=form-control text-right numeric currency thousandSeparator" id="MaintenanceItems_' + countRowItem + '__Ppn" name="MaintenanceItems[' + countRowItem + '].Ppn" onkeypress="return event.charCode >= 48 && event.charCode <= 57" type="text" value="">' +
                                                '</div>' +
                                        '</td>' +
                                        '<td>' +
                                            '<div class="input-group">' +
                                                '<input class="form-control text-right numeric currency thousandSeparator" id="MaintenanceItems_' + countRowItem + '__Pph" name="MaintenanceItems[' + countRowItem + '].Pph" onkeypress="return event.charCode >= 48 && event.charCode <= 57" type="text" value="">' +
                                                '</div>' +
                                        '</td>' +
                                        '<td>' +
                                            '<div class="input-group">' +
                ...
                '</td>' +
                '<td style = "display:none"><input class="form-control" type="text" id="idHistory" value="' + idHistoryMT + '"/></td>' +
            '</tr>');
    ...
    function UpdateMTNItemList(statusHistory) {
        ...
        var data = { MTNItemList: [], IdMTNHistory: idMtnHistory, Status: statusHistory, IsBilledToCustomer: isBilled};
