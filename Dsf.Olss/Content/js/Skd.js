...
function reCountOperatingLeaseIncome() {
    ...
    $("#Vat").val(($("#PPNValue").val() / 100) * $("#MonthlyOperatingLease").val());
    $("#Billing").val(parseFloat($("#MonthlyOperatingLease").val()) + parseFloat($("#Vat").val()));
    $("#WithholdingTaxArt23").val(($("#PPHValue").val() / 100) * $("#MonthlyOperatingLease").val());
...
function loadQuotationData() {
    ...
    $("#quotation-list tbody").delegate("tr", "click", function() {
        ...
        $("#PPHValue").val(data.PPHValue);
        $("#PPNValue").val(data.PPNValue);
        ...
        $("#Vat").val((data.PPNValue / 100) * $("#MonthlyOperatingLease").val());
        $("#Billing").val(parseFloat($("#MonthlyOperatingLease").val()) + parseFloat($("#Vat").val()));
        $("#WithholdingTaxArt23").val((data.PPHValue / 100) * $("#MonthlyOperatingLease").val());
        $("#NetPayment").val($("#Billing").val() - $("#WithholdingTaxArt23").val());
        $("#lblVATPersen").text("VAT " + parseInt(data.PPNValue) + "% (+)");
        $("#lblPPHPersen").text("Withholding Tax Art 23 (" + parseInt(data.PPHValue) + "%)");
