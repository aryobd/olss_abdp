        ...
        window[ObjectName] = $(this).dataTable({
            ...
            },
            {
                ...
                "fnRender": function(oObj) {
                    ...
                    if (!IsUnit) {
                        if (UnitReadinessValue != sComplete) {
                            retElement = "<textarea class='form-control remark-field " + (!AllowEdit ? "readonly" : "") + "' rows='2' style='width: 200px;' maxlength='100' " + (!AllowEdit ? "readonly" : "") + ">" + (Remark != null ? Remark : "") + "</textarea>";
                        ...
                        if (BASTActual != null && BASTActual != "")
                            ...
                            retElement = "<textarea class='form-control remark-field " + (UnitReadinessValue == sComplete ? "readonly" : (!AllowEdit ? "readonly" : "")) + "' rows='2' style='width: 200px;' maxlength='100' " + (UnitReadinessValue == sComplete ? "readonly" : (!AllowEdit ? "readonly" : "")) + ">" + (Remark != null ? Remark : "") + "</textarea>";
                            retElement += "<span class='field-validation-error' style='display: none;'>The Remark field is required.</span>";
                        }
                    }
                    return retElement;
