...
namespace Dsf.Olss.Tests.Net
{
    ...
    public class PurchaseOrderControllerTests
    {
        ...
        public void A_PurchaseOrder_AddDetailEditReport_GetPPNValueByCreatedDate_IsValidData()
        {
            //Arrange       
            string[] getConfig = ConfigurationManager
                .AppSettings["PurchaseOrder_AddDetailEditReport_GetPPNValueByCreatedDate_IsValidData"]
                .Split(',');
