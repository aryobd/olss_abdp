...
{
    [TestClass]
    public class MaintenancePaymentApprovalControllerTests
    {
        ...
        public void A_MaintenancePaymentApproval_AddEditPaymentApproval_GetPPNValueByPaymentApprovalCreatedDate_IsValidData()
        {
            //Arrange       
            string[] getConfig = ConfigurationManager
                .AppSettings["MaintenancePaymentApproval_AddEditPaymentApproval_GetPPNValueByPaymentApprovalCreatedDate_IsValidData"]
                .Split(',');
        ...
        [TestMethod]
        [TestCategory("S0266337")]
        public void B_MaintenancePaymentApproval_AddEditPaymentApproval_GetPPHValueByPaymentApprovalCreatedDate_IsValidData()
        {
            //Arrange       
            string[] getConfig = ConfigurationManager
                .AppSettings["MaintenancePaymentApproval_AddEditPaymentApproval_GetPPHValueByPaymentApprovalCreatedDate_IsValidData"]
                .Split(',');
