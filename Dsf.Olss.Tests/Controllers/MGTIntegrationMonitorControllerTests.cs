...
{
    [TestClass]
    public class MGTIntegrationMonitorControllerTests
    {
        ...
        public void A_MGTIntegrationMonitor_SendDataToSTGMFAPPL_GetPPNValueByAgrCreatedDate_IsValidData()
        {
            //Arrange       
            string[] getConfig = ConfigurationManager
                .AppSettings["MGTIntegrationMonitor_SendDataToSTGMFAPPL_GetPPNValueByAgrCreatedDate_IsValidData"]
                .Split(',');
        ...
        [TestMethod]
        [TestCategory("S0266337")]
        public void B_MGTIntegrationMonitor_SendDataToSTGMFAPPL_GetPPHValueByAgrCreatedDate_IsValidData()
        {
            //Arrange       
            string[] getConfig = ConfigurationManager
                .AppSettings["MGTIntegrationMonitor_SendDataToSTGMFAPPL_GetPPHValueByAgrCreatedDate_IsValidData"]
                .Split(',');
