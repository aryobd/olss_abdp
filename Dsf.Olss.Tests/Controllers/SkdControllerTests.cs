...
{
    [TestClass]
    public class SkdControllerTests
    {
        ...
        public void A_SKD_AddDetailEditReport_GetPPNValueByCreatedDate_IsValidData()
        {
            //Arrange       
            string[] getConfig = ConfigurationManager
                .AppSettings["SKD_AddDetailEditReport_GetPPNValueByCreatedDate_IsValidData"]
                .Split(',');
        ...
        [TestMethod]
        [TestCategory("S0266337")]
        public void B_SKD_AddDetailEditReport_GetPPHValueByCreatedDate_IsValidData()
        {
            //Arrange       
            string[] getConfig = ConfigurationManager
                .AppSettings["SKD_AddDetailEditReport_GetPPHValueByCreatedDate_IsValidData"]
                .Split(',');
